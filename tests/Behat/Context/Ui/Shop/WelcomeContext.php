...
namespace Tests\Brightweb\SyliusStanConnectPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Brightweb\SyliusStanConnectPlugin\Behat\Page\Shop\WelcomePageInterface;
